...
jQuery.fn.extend({
    ...
    tableTemplate : function(opt)
    {
        return this.each(function()
        {
            ...
            if(typeof opt != "undefined" && typeof opt.placeholder != "undefined")
            {
            ...
            $(this).on("click", ".row-adder", function(e, e_opt)
            {
                ...
                var tr_html = String.replaceAll(placeholder.id, last_id, template_row);
                tr_html = String.replaceAll(placeholder.i, last_i, tr_html);
